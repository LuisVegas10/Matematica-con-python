...
# DONE: Esta funcion devuelve la opcion seleccionada.
def getOpciones() -> int:
    while True:  # Un ciclo que se repetira hasta que se ingrese un numero valido
        try:
            opcion = int(input("Ingrese una opcion (00-45): "))
            if opcion >= 0 and opcion <= 45:
                return opcion
            elif opcion < 0:
                print("¡¡LA OPCIÓN DEBE SER MAYOR A 0!!")
            else:
                print("¡¡LA OPCIÓN DEBE SER MENOR O IGUAL A 45!!")
        except Exception as exception:
            print("¡¡ERROR: DEBE INGRESAR UN NUMERO!!")


# DONE: Esta funcion devuelve un numero flotante.
def getNumber(mensaje: str) -> float:
    while True:  # Un ciclo que se repetira hasta que se ingrese un numero valido
        try:
...
def getRetornarBinario(binario: str) -> str:
    ...
    if isBinario:
        ...
        print(f"El valor {binario} no es binario.")
    return resultado
...
if opcion == 0:
    print("GRACIA POR SU PARTICIPACIÓN")
else:
    time.sleep(2)
    if opcion == 1:
        print("****Suma de dos valores")
        nUno = getNumber("Ingrese el valor 1: ")
        nDos = getNumber("Ingrese el valor 2: ")
        suma(nUno, nDos)
    elif opcion == 2:
        ...
        factor1 = getNumber("Ingrese el valor 1: ")
        factor2 = getNumber("Ingrese el valor 2: ")
        Multiplicacion(factor1, factor2)
    elif opcion == 4:
        print("****Division de dos valores")
        dividendo = getNumber("Ingrese el numerador: ")
        divisor = getNumber("Ingrese el divisor: ")
        ...
        print("****Potencia")
        base = getNumber("Ingrese la base: ")
        exponente = getNumber("Ingrese el exponente: ")
        potenciacion(base, exponente)
    elif opcion == 7:
        print("****Exponencial e")
        exponente = getNumber("Ingrese el valor: ")
        potenciacionBasee(exponente)
    elif opcion == 8:
        print("****Logaritmo Neperiano")
        argumento = getNumber("Ingrese el valor: ")
        log(argumento)
    elif opcion == 9:
        ...
        print("****Raiz Cuadrada")
        subradical = getNumber("Ingrese el valor: ")
        raizCuadrada(subradical)
    elif opcion == 11:
        print("****Coseno")
        nUno = getNumber("Ingrese el valor: ")
        coseno(nUno)
    elif opcion == 12:
        print("****ArcoCoseno")
        nUno = getNumber("Ingrese el valor: ")
        ...
        radianes = getNumber("Ingrese los radianes: ")
        getGrados(radianes)
    elif opcion == 36:
        print("****Pasar de Grados a Radianes")
        grados = getNumber("Ingrese los grados: ")
        getRadianes(grados)
    elif opcion == 37:
        print("****Numero π")
        getPI()
        ...
        nA = getNumber("Ingrese el valor a: ")
        nB = getNumber("Ingrese el valor b: ")
        nC = getNumber("Ingrese el valor c: ")
        ...
        decimales = getNumber("Ingrese los decimales: ")
        getFraccion(decimales)
    elif opcion == 43:
        print("****Convertir Fraccion a Decimal")
        numerador = int(getNumber("Ingrese el numerador: "))
        denominador = int(getNumber("Ingrese el denominador: "))
        getDecimal(Fraction(numerador, denominador))
    elif opcion == 44:
        print("****Convertir valor a Binario")
        valor = int(getNumber("Ingrese el valor: "))
        getBinario(valor)
    elif opcion == 45:
        print("****Convertir Binario a valor")
        binario = str(int(getNumber("Ingrese el codigo Binario: ")))
